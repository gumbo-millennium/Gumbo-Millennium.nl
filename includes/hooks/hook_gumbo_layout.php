...
function add_gumbo_layout()
{
  ...
  global $phpbb_root_path, $phpEx, $template, $user, $auth;
	...
	$template->assign_vars(array(
		...
		'U_COMMITTEE'			=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx"),
		'L_COMMITTEE'			=> $user->lang['COMMITTEE'],
		'U_BOARD_OF_DIRECTORS'	=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=directors"),
		'L_BOARD_OF_DIRECTORS'	=> $user->lang['BOARD_OF_DIRECTORS'],
		'U_DC'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=dc"),
		'L_DC'					=> $user->lang['DC'],
		'U_SC'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=sc"),
		'L_SC'					=> $user->lang['SC'],
		'U_PC'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=pc"),
		'L_PC'					=> $user->lang['PC'],
		'U_AC'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=ac"),
		'L_AC'					=> $user->lang['AC'],
		'U_GC'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=gc"),
		'L_GC'					=> $user->lang['GC'],
		'U_KASCIE'				=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=kas"),
		'L_KASCIE'				=> $user->lang['KC'],
		'U_IB'					=> append_sid("{$phpbb_root_path}gumbo/committee.$phpEx", "c=ib"),
		'L_IB'					=> $user->lang['IB'],
