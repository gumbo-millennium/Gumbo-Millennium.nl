<?php
	...
	*/
	...
	$template->assign_block_vars('navlinks', array(
		'FORUM_NAME'		=> $user->lang['DISPUTES'],
		'U_VIEW_FORUM'		=> append_sid("{$phpbb_root_path}gumbo/disputes.$phpEx" )) //The path to the custom file relative to the phpbb root path.            
	);
	
	// Output page
	page_header($user->lang['DISPUTES']);
