<?php
	...
	*/
	...
	$sql = 'SELECT * FROM ' . POSTS_TABLE . ' AS p WHERE post_id = 1385';
	...
	$template->assign_block_vars('navlinks', array(
		'FORUM_NAME'		=> $user->lang['ALIQUANDO'],
		'U_VIEW_FORUM'		=> append_sid("{$phpbb_root_path}gumbo/aliquando.$phpEx" )) //The path to the custom file relative to the phpbb root path.            
	);
	
	// Output page
	page_header($user->lang['ALIQUANDO']);
