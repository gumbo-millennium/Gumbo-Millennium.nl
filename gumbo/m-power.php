<?php
	...
	*/
	...
	$sql = 'SELECT * FROM ' . POSTS_TABLE . ' AS p WHERE post_id = 1383';
	...
	$template->assign_block_vars('navlinks', array(
		'FORUM_NAME'		=> $user->lang['M-POWER'],
		'U_VIEW_FORUM'		=> append_sid("{$phpbb_root_path}gumbo/m-power.$phpEx" )) //The path to the custom file relative to the phpbb root path.            
	);
	
	// Output page
	page_header($user->lang['M-POWER']);
