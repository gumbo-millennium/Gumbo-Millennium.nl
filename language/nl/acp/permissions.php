...
$lang = array_merge($lang, array(
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Hier kun je beheerderspermissies toewijzen aan gebruikers of groepen. Alle gebruikers met beheerderpermissies kunnen het beheerderspaneel zien.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Hier kun je globale moderatorpermissies toewijzen aan gebruikers of groepen. Deze moderators hebben dezelfde rechten als normale moderators, echter hebben ze deze rechten op alle forums.',
	'ACP_GROUPS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier kun je forumpermissies toewijzen aan groepen.',
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Hier kun je globale permissies toewijzen aan groepen - gebruikerspermissies, globale moderatorpermissies en beheerderpermissies. Gebruikerspermissies hebben de mogelijkheden als het gebruik van avatars, privéberichten versturen, enz.; Globale moderatorpermissies zoals het goedkeuren van berichten, beheren van onderwerpen, beheren van bans, etc. En tenslotte beheerderpermissies zoals het toewijzen van permissies, beheer van aangepaste BBCodes en forums, etc. Persoonlijke gebruikerspermissies zouden alleen in sommige gevallen veranderd moeten worden. De aanbevolen methode is gebruikers in groepen plaatsen en aan die groepen de permissies toewijzen.',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Hier kun je de rollen wijzigen voor beheerderpermissies. Rollen zijn effectieve permissies. Als je een rol wijzigt, wijzigen de permissies van een item met deze rol toegewezen ook.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Hier kun je de rollen wijzigen voor forumpermissies. Rollen zijn effectieve permissies. Als je een rol wijzigt, wijzigen de permissies van een item met deze rol toegewezen ook.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Hier kun je de rollen wijzigen voor moderatiepermissies. Rollen zijn effectieve permissies. Als je een rol wijzigt, wijzigen de permissies van een item met deze rol toegewezen ook.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Hier kun je de rollen wijzigen voor gebruikerspermissies. Rollen zijn effectieve permissies. Als je een rol wijzigt, wijzigen de permissies van een item met deze rol toegewezen ook.',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Hier kun je forumpermissies per forum toewijzen aan gebruikers.',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Hier kun je globale permissies toewijzen aan gebruikers - gebruikerspermissies, globale moderatorpermissies en beheerderpermissies. Gebruikerspermissies hebben de mogelijkheden als het gebruik van avatars, privéberichten versturen, enz.; Globale moderatorpermissies zoals het goedkeuren van berichten, beheren van onderwerpen, beheren van bans, etc. En tenslotte beheerderpermissies zoals het toewijzen van permissies, beheer van aangepaste BBCodes en forums, etc. Persoonlijke gebruikerspermissies zouden alleen in sommige gevallen veranderd moeten worden. De aanbevolen methode is gebruikers in groepen plaatsen en aan die groepen de permissies toewijzen.',
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> 'Hier kun je de globale moderatiepermissies zien, die zijn toegewezen aan de geselecteerde gebruikers en groepen.',
	...
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> 'Hier kun je de forum moderatorpermissies zien, die zijn toegewezen aan de geselecteerde gebruikers, groepen en forums.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD'		=> 'Heeft toegang tot de meeste gebruikersfuncties, maar kan niet de eigen gebruikersnaam veranderen of de tijdsinterval negeren.',
	...
	'SET_ROLE_PERMISSIONS'			=> 'Stel rolpermissies in',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'De gebruikerspermissie staat op <samp>NEE</samp> en de totale waarde staat op <samp>NEE</samp>, dus niets veranderd.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'De gebruikerspermissie staat op <samp>NEE</samp> en de totale waarde staat op <samp>NEE</samp>, dus niets veranderd.',
	...
	'TRACE_USER_YES_TOTAL_YES'				=> 'De gebruikerspermissie staat op <samp>JA</samp> en totale waarde staat op <samp>JA</samp>, dus niets veranderd.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'De gebruikerspermissie staat op <samp>JA</samp> en totale waarde staat op <samp>JA</samp>, dus niets veranderd',
	'TRACE_WHO'								=> 'Wie',
	'TRACE_TOTAL'							=> 'Totaal',
